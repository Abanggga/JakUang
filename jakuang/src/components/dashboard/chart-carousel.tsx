...
export function ChartCarousel() {
  ...
  return (
    <div className="flex col-span-12 lg:col-span-8 bg-surface-container-lowest rounded-3xl border border-outline-variant/60 shadow-sm p-4 md:p-8 min-h-[350px] md:min-h-[400px] flex-col w-full min-w-0 overflow-hidden">
      {/* Header & Controls */}

...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#F6F9FF] via-[#E5DEFF] to-[#F6F9FF] p-4">
      {/* Decorative blobs */}
      <div className="absolute top-0 left-0 w-96 h-96 bg-[#5A45CB]/10 rounded-full blur-3xl -translate-x-1/2 -translate-y-1/2" />
      <div className="absolute bottom-0 right-0 w-96 h-96 bg-[#FFD700]/10 rounded-full blur-3xl translate-x-1/2 translate-y-1/2" />
      ...
      <Card className="w-full max-w-md relative z-10 border-border/50 shadow-2xl shadow-[#5A45CB]/5">
        ...
        <CardContent className="space-y-5 pt-2">
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <a href="#" className="text-xs text-[#5A45CB] hover:underline">
                  Lupa password?
                </a>
              </div>
              <div className="relative">
          ...
          <p className="text-center text-sm text-muted-foreground">
            ...
            <Link
              href="/register"
              className="text-[#5A45CB] font-medium hover:underline"
            >
              Daftar sekarang
            </Link>
          </p>

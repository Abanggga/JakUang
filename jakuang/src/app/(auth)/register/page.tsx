    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#F6F9FF] via-[#E5DEFF] to-[#F6F9FF] p-4">
      ...
      <Card className="w-full max-w-md relative z-10 border-border/50 shadow-2xl shadow-[#5A45CB]/5">
        ...
        <CardContent className="space-y-5 pt-2">
          <form onSubmit={handleRegister} className="space-y-4">
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input id="register-name" placeholder="Andi Pratama" className="pl-10" required />
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input id="register-email" type="email" placeholder="andi@email.com" className="pl-10" required />
              </div>
            </div>
            ...
            <Button type="submit" className="w-full bg-[#5A45CB] hover:bg-[#442BB5] text-white font-medium h-11" disabled={loading}>
          ...
          <Button variant="outline" className="w-full h-11 gap-3 font-medium" disabled={loading}>
